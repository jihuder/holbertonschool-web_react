...
describe("courseReducer", () => {
  it("Verify the default state returns an initial state", () => {
  ...
  it("Verify MARK_AS_READ returns the data with the right item updated", () => {
    const initialState = {
      filter: "DEFAULT",
      notifications: [
        {
  ...
  it("Verify SET_TYPE_FILTER returns the data with the right item updated", () => {
    const initialState = {
      filter: "DEFAULT",
      notifications: [
        {
